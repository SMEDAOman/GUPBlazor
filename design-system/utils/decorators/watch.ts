// Original version https://github.com/sebgroup/green/blob/main/libs/core/src/utils/decorators/watch.ts
...
export function watch(propertyName: string | string[], options?: WatchOptions) {
  ...
  return <ElemClass extends LitElement>(
    proto: ElemClass,
    _propertyKey: string,
    descriptor: TypedPropertyDescriptor<UpdateHandler> | TypedPropertyDescriptor<() => Promise<void>>
  ) => {
